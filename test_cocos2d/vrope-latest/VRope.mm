...
//            CCSprite *tmpSprite = [CCSprite spriteWithFile:@"rope.png" rect:CGRectMake(0,0,multiplier,[[[spriteSheet textureAtlas] texture] pixelsHigh])];
            
              CCSprite *tmpSprite = [CCSprite spriteWithFile:@"rope.png"];
